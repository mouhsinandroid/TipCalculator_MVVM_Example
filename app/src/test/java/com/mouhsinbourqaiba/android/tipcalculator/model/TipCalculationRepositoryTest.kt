...
class TipCalculationRepositoryTest {
    ...
    fun testSaveTip() {
        ...
        assertEquals(tip, repository.loadTipCalculation(tip.locationName))
    }

    @Test
    fun testLoadSavedCalculations() {
        ...
        repository.loadSavedTipCalculations().observeForever { tipCalcuation ->
            assertEquals(2, tipCalcuation?.size)
        }
